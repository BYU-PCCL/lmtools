...
class LM_GPT3(LMSamplerBaseClass):
    def __init__(self, model_name):
        """
        Supported models: 'ada', 'babbage', 'curie', 'davinci', 'gpt3-ada', gpt3-babbage', gpt3-curie', gpt3-davinci', 'text-ada-001', 'text-babbage-001', 'text-curie-001', 'text-davinci-002'
        """
        ...
        if self.engine not in ["ada", "babbage", "curie", "davinci", "text-ada-001", "text-babbage-001", "text-curie-001", "text-davinci-002"]:
            raise ValueError(
                "Invalid model name. Must be one of: 'ada', 'babbage', 'curie', 'davinci', 'text-ada-001', 'text-babbage-001', 'text-curie-001', 'text-davinci-002'"
            )
